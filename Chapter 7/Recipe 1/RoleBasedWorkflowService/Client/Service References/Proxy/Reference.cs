...
namespace Client.Proxy {
    ...
    public interface IService {
        ...
        Client.Proxy.GetDataResponse GetData(Client.Proxy.GetDataRequest request);
    }
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<Client.Proxy.IService>, Client.Proxy.IService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Client.Proxy.GetDataResponse Client.Proxy.IService.GetData(Client.Proxy.GetDataRequest request) {
            return base.Channel.GetData(request);
        }
        
        public string GetData(System.Nullable<int> @int) {
            Client.Proxy.GetDataRequest inValue = new Client.Proxy.GetDataRequest();
            inValue.@int = @int;
            Client.Proxy.GetDataResponse retVal = ((Client.Proxy.IService)(this)).GetData(inValue);
